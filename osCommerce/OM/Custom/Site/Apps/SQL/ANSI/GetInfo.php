 ...
 */
  ...
  class GetInfo {
    public static function execute($data) {
      ...
      if ( !empty($app) ) {
        $Qrel = $OSCOM_PDO->prepare('select af.app_version, af.core_dep, unix_timestamp(af.date_added) as date_added, ac.changelog from :table_website_apps_files af, :table_website_apps_files_changelog ac where af.app_id = :app_id and af.id = ac.file_id and ac.language_id = :language_id order by af.core_dep, af.app_version');
