html_page_title = New Submission | Apps Marketplace | osCommerce
html_page_title_update = Submit Update | Apps Marketplace | osCommerce

heading_new_submission = New Submission
heading_update_submission = Submit Update

field_license = License
field_license_info = This cannot be changed once set. A new license requires a new submission.
field_license_group_free = Free
...
field_update_description = Description / Changelog
field_version = OSCOM Version
field_version_info = The minimum osCommerce Online Merchant version required. This cannot be changed once set. A new base version requires a new submission.
field_category = Category
field_category_info = This cannot be changed once set. A new category requires a new submission.
field_upload = Upload
field_upload_info = 1 zip file, 1 cover image, and up to 7 screenshots are allowed. Max file size :maxsizeMB.
field_upload_info_zip = zip packaged file
...
field_terms = I acknowledge that I have the legal rights and permission to perform this submission and to make it available to others to the terms of the selected license. I have made sure this submission is not harmful and have included the appropriate legal notices and privacy guidelines in the file package.
...
ms_error_terms_update = Please accept the terms to perform the upload.
...
ms_error_version = Please select a minimum osCommerce Online Merchant version required for the file submission.
ms_error_category = Please select a category for the file submission.
ms_error_zip_required = A zip file is required for the file submission.
ms_error_zip_internal_invalid_filename = The processed zip file has an invalid filename. Please try the upload again.
ms_error_zip_internal_nonexistant = The processed zip file does not exist. Please try the upload again.
ms_error_zip_min_size = The minimum size of the uploaded zip file must be at least :min_size bytes. Please try the upload again with a valid zip file.
...
ms_error_zip_multiple = Only 1 zip file upload is allowed.
...
update_field_upload_info = 1 zip file is allowed. Max file size :maxsizeMB.

button_cancel_update_submission = or cancel

ms_error_submit_update_no_access = Access has not been provided to submit an update to the App.
